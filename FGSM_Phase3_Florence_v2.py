# Auto-generated from FGSM_Phase3_Florence_v2.ipynb
# Conversion style: Jupytext-like cell markers

# %% [markdown]
# # FGSM Phase 3 v2 — Florence-2-Base
#
# **1000 images** | single GPU | **NO CHECKPOINT**
# Attack: FGSM, eps=0.03 in normalized pixel space.
...
OUTPUT_DIR = "./results_phase3_florence_fgsm_v2"
...
# %%
# ============================================================
# FGSM Attack (Florence-2) — normalized-pixel space, single step
# Uses model's own beam-search prediction as target (untargeted).
# ============================================================
